...
//////
    ...
    {
        Eigen::Quaternionf q_corr(0.9989, -0.0213, 0.0426, 0.0072);
        ...
        Eigen::Matrix3f tfCameraRotationTemp = tfORBToROS * (R_corr * tfCameraRotation);
        Eigen::Vector3f tfCameraTranslationTemp = tfORBToROS * (R_corr * tfCameraTranslation);
